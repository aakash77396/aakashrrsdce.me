...
<body>
    <img src="bg.jpg" alt="bg-image" class="bg">
    <div class="container">
        <h1>Welcome to R.R.S.D.C.E.BEGUSARAI trip form</h1>
        <P>Enter your details and submit this form to confirm your participation in the trip</P>
        <?php
           if($insert == true){
           echo "<p class='submitmsg'>Thanks for submitting your form. we are happy to see you joining us for the R.R.S.D.C.E.BEGUSARAI trip </p>";
           }
        ?>
